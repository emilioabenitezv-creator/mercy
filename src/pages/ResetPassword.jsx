...
export default function ResetPassword() {
  ...
  if (!resetToken) {
    return (
      <AuthLayout
        ...
        subtitle="Este enlace de restablecimiento es inválido o está incompleto"
        footer={
  ...
  return (
    <AuthLayout icon={Lock} title="Nueva contraseña" subtitle="Ingresa tu nueva contraseña">
      {error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" className="w-full h-12 font-medium" disabled={loading}>
          {loading ? (<><Loader2 className="w-4 h-4 mr-2 animate-spin" />Restableciendo…</>) : ("Restablecer contraseña")}
        </Button>
      </form>
    </AuthLayout>
  );
